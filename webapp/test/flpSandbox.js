		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#accenturetutorial3ui5tutorial3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"accenturetutorial3ui5tutorial3-display": {
								"semanticObject": "accenturetutorial3ui5tutorial3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=accenture.tutorial3.ui5.tutorial3",
									"url": sap.ui.require.toUrl("accenture/tutorial3/ui5/tutorial3")
								}
							}
						}
					}
